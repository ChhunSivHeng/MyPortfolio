      ...
      <div className="max-w-full">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-start">
          ...
          <div className="space-y-6">
            <div>
              <p className="text-primary text-sm font-medium tracking-wider mb-2 text-left">
                HELLO, I&apos;M
              </p>
              <h1 className="text-4xl lg:text-5xl font-bold text-foreground leading-tight text-left">
                Chhun Sivheng
              </h1>
              <p className="text-xl text-muted-foreground mt-3 text-left">
          ...
          <div className="space-y-8">
            <div className="space-y-4">
              <h2 className="text-sm font-medium text-primary tracking-wider text-left">ABOUT ME</h2>
              <p className="text-muted-foreground leading-relaxed text-left">
